    ...
    <>
      <div className="container about-container" id='about'>
        ...
        <div class="about-content">
          <div class="mb-4">
            <h3 class="text-primary text-uppercase bold">About Us</h3>
            <h1 class="text-uppercase mb-0 bold">Welcome to Zara Roller<br/>Skating Academy</h1>
          </div>
          <h4 class="mb-4">"There are NO LIMITS to what you can Achieve. Only Niro Roller Skating Academy makes you DREAM BIG AIM HIGH and never leave you GIVE UP."</h4>
